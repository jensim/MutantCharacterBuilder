...
public class MutantBaseStatCharacter implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "MUTANT_BASE_STAT_CHARACTER_ID_GENERATOR",
	sequenceName = "MUTANT_BASE_STAT_CHARACTER_ID_SEQ",
	allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE,
	generator = "MUTANT_BASE_STAT_CHARACTER_ID_GENERATOR")
