 ...
 */
@Entity
@Table(name = "trudvang_weapon_projectile", catalog = "rollspel", schema = "public")
public class TrudvangWeaponProjectile implements Serializable {

	@Id
	@SequenceGenerator(name = "TRUDVANG_WEAPON_PROJECTILE_ID_GENERATOR",
	sequenceName = "trudvang_weapon_projectile_id_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE,
	generator = "TRUDVANG_WEAPON_PROJECTILE_ID_GENERATOR")
